...
class Metrics(BaseMetrics):
    ...
    def add_user_list_api_interaction(self, **kwargs: Dict[str, Any]) -> None:
        """
        Increment the counter for API requests related to user lists, including the number of lists
        added, deleted, items added, and deleted, as well as the response time. We use the provided
