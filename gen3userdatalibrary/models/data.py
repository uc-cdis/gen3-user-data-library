...
endpoints_to_context = {
    "redirect_to_docs": {"resource": "/gen3_data_library/service_info/redoc",
                         "method": "read"},
    "get_version": {"resource": "/gen3_data_library/service_info/version",
                    "method": "read"},
    "get_status": {"resource": "/gen3_data_library/service_info/status",
                   "method": "read"},
    "read_all_lists": {
        "type": "all",
    ...
    "upsert_user_lists": {
        ...
        "resource": lambda user_id: get_lists_endpoint(user_id),
        "method": "update",
        "items": lambda body: list(map(lambda item_to_update: item_to_update["items"], body["lists"]))
    },
    "delete_all_lists": {
        "type": "all",
        "resource": lambda user_id: get_lists_endpoint(user_id),
